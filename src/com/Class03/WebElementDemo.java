...
public class WebElementDemo extends CommonMethods{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElementDemo userName=(WebElementDemo) driver.findElement(By.xpath("//input[@id='txtUsername']"));
		...
		WebElementDemo errorMessage=driver.findElement(By.xpath("//span[@id='spanMessage']"));
